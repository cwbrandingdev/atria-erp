...
let MetaInsightsService = class MetaInsightsService {
    ...
    getOverview() {
        ...
        const impressions = this.campaigns.reduce((sum, c) => sum + c.impressions, 0);
        ...
        const totalEngagements = this.campaigns.reduce((sum, c) => sum + Math.round(c.impressions * (c.ctr / 100) * 1.8), 0);
    ...
    getClientMonthlyMetrics(clientId, month, year) {
...
exports.MetaInsightsService = MetaInsightsService = __decorate([
